...
*/
function opgave1(str = "Hvem kan godt lide kage?") {
...
*/
function opgave2(Min = 1, max = 10) {
    tal = Math.floor(Math.random() * (10 - 1) ) + 1;
    Console.log(tal)
}
...
function opgave4(array = ["Hej", "med", "Dig"]) {    
   console.log(array[2]);
    } else{
...
/*
    ...
    arr: Arrayet med tal
*/
function opgave5(x=2, y=3, z=4) {
     Produkt= return x*y*z;
     console.log(produkt)
...
*/
function opgave7(arr1=[2, 4, 6, 7], arr2=[3,4,5,8]) {
