...
var fin = [];
fin.push((dato.getDate()+"."));
fin.push(måned(dato));
fin.push(dato.getyear());
return fin;
};
function måned (dato) {
    if (dato.getMonth() = 0) {
      return ("januar");
    } else if (dato.getMonth() = 1) {
       return ("februar");
    } else if (dato.getMonth() = 2) {
       return ("marts");
    } else if (dato.getMonth() = 3) {
        return ("april");
    } else if (dato.getMonth() = 4) {
        return ("maj");
    } else if (dato.getMonth() = 5) {
        return ("juni");
    } else if (dato.getMonth() = 6) {
        return ("Juli");
    } else if (dato.getMonth() = 7) {
        return ("august");
    } else if (dato.getMonth() = 8) {
        return ("september");
    } else if (dato.getMonth() = 9) {
        return ("oktober");
    } else if (dato.getMonth() = 10) {
        return ("november");
    } else if (dato.getMonth() = 11) {
        return ("december");
    }
};
